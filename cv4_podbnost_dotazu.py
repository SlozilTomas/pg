from cv4_jaccard import jaccardova_vzdalenost_mnozin
from cv4_levenstein import levensteinova_vzdalenost

def deduplikace_dotazu(dotazy):
    """
    tato funkce spocita jaccardovu vzdalenost a levensteinovu vzdalenost a vyradi ze seznamu dotazy, polozky,
    ktere budou mit jaccardovu vzdalenost mensi nez 0,5 a levensteinovu vzdalenost <= 1
    """
    i = 0
    while i < len(dotazy):
        dotaz1 = dotazy[i]
